  ...
  if (localStorage) {
    ...
    if (hotWords.length) {        
      for (var i = 0; i <= hotWords.length - 1; i++) {
        str += '<div class="order-details-rr historical-list"><a href="#" class="historical-wz">' + hotWords[i] + '</a><a href="#'+i+'" class="yy-icon-xx historical-search-close history-rm"></a></div>';
      };
